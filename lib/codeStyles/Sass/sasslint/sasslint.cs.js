...
const fileNames = ['.sass-lint.yaml'];
...
Bear in mind that only some sass-lint rules can be auto-fixed.
        ...
        },
        {
            name: 'setup',
            detail:
                'npm install -D sass-lint@^1.12.1 sass-lint-auto-fix@^0.11.2'
        },
        {
            name: 'run-local',
            detail:
                'node_modules/.bin/sass-lint -c .sass-lint.yml && echo "All files are formatted correctly."'
        },
        {
            name: 'run-pipeline',
            detail:
